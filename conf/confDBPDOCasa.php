...
/*
define('DSN', 'mysql:host=192.168.20.19;dbname=DB207DWESProyectoTema4');//Direccion IP del host y nombre de la base de datos
define('USER', 'user206DWESProyectoTema4');//Nombre del usuario de la base de datos
